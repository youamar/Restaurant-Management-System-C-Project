...
namespace Main_Page
{
    public partial class AboutUs : Form
    {
        ...
        public AboutUs()
        {
            ...
            name.Parent = pictureBox;
            description.Parent = pictureBox;

            labels = new Label[] { name, description, history, address, email };
            AboutUsControl _aboutUsControl = new AboutUsControl(this, labels);
            _aboutUsControl.LoadData();
        }
